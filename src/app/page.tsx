        ...
        <div className="flex flex-col gap-4">
          <div className="flex">
            ...
            <svg viewBox="0 0 180 30" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M0 27 L90 9.857142857142858 L108 13.285714285714285 L126 9.857142857142858 L144 13.285714285714285 L180 3" stroke="blue" strokeDasharray="6, 6" strokeWidth="3" fill="none">
              </path>
            </svg>
          </div>

...
export default function LeftNav() {
    ...
    return (
        <div>
            ...
            <Link href={Routes.Questions} className={`${buttonStyle} ${pathname === Routes.Questions ? selectedStyle : ""}`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            <Link href={Routes.Bookmarks} className={`${buttonStyle} ${pathname === Routes.Bookmarks ? selectedStyle : ""}`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
